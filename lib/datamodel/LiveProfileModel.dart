...
class LiveProfileModel {
  ...
  String _localStations ="https://api-stg1.iheart.com/api/v2/content/liveStations?allMarkets=false&="+LIMIT+"&offset=0&zipCode="+ZIP_CODE;
  ...
  String _getStationApi(String zipcode, int size) {
    ...
    return apiUrl.replaceAll(ZIP_CODE, zipcode);
  }
  ...
  Future<Schedule> getSchedules(final String callLetter, int size) async {
      var response = await http.get(
        this._getScheduleApi(callLetter, 10),
      );
